...
task usercontrol () {
  ...
  while (1) {
    ...
    motor[DriveLeft1] = tmp * -con;
    motor[DriveRight1] = 0.8*tmp * -con;
    motor[DriveRight2] = tmp * -con;
    motor[DriveLeft2] = tmp * -con;

    // Left axle turn
    if (vexRT[Btn5U]) {
      motor[DriveLeft1] = vexRT[Btn5U] * 100 * con;
      motor[DriveRight1] = vexRT[Btn5U] * -100 * con;
      motor[DriveRight2] = vexRT[Btn5U] * -100 * con;
      motor[DriveLeft2] = vexRT[Btn5U] * 100 * con;
    }
    // Right axle turn
    else if (vexRT[Btn6U]) {
      motor[DriveLeft1] = vexRT[Btn6U] * 100 * -con;
      motor[DriveRight1] = vexRT[Btn6U] * -100 * -con;
      motor[DriveRight2] = vexRT[Btn6U] * -100 * -con;
      motor[DriveLeft2] = vexRT[Btn6U] * 100 * -con;
    }
    
    // Make descorer go down
    if (vexRT[Btn7U]) {
      motor[Descorer] = vexRT[Btn7U] * 100 * con;
    }

    // Make descorer go up
    else if (vexRT[Btn7D]) {
      motor[Descorer] = vexRT[Btn7D] * 100 * -con;
    }
    ...
    // Implement indexer and (maybe) 3rd intake here...
		if (vexRT[Btn7R]) {
			motor[Indexer] = vexRT[Btn7R] * -100 * con; 	
		}
		else if (vexRT[Btn7L]) {
			motor[Indexer] = vexRT[Btn7L] * 100 * con;	
		}
		else {
			StopBallIndexer();	
		}
